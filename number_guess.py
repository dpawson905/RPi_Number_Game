...
try:
    ...
    def main():
        ...
        if player == "n" or player == "no":
            ...
            print("Something went wrong, chances are you typed something other than y/n. " +
                  "Try again!")
            main()
    ...
    def intro():
        ...
        time.sleep(0.75)
        delay_print(
            "If your guess is too low, the Yellow LED will light up...\n")
        time.sleep(0.75)
        delay_print(
            "If your guess is the same as my number, the Green LED will light...\n")
        time.sleep(0.75)
        delay_print("And the buzzer will go off!\n")
        time.sleep(0.75)
        delay_print(
            "And remember... If you cannot guess my number within 10 tries...\n")
        time.sleep(0.75)
        delay_print(
            "The game is over and all the lights will flash and the buzzer will sound.\n")
        time.sleep(0.75)
    ...
    def start_game():
        ...
        while user_tries <= total_tries:
            ...
            if player < 1 or player > 100:
            ...
            elif player is ValueError:
                print("That is invalid, it must be a number!")
            else:
                if player < RANDOM_NUMBER:
                    ...
                    user_tries += 1
                    print("YOU WIN!... You guessed the number in %i trys" %
                          user_tries)
            ...
            if user_tries > total_tries:
                print("You lost, you didnt guess the number in time, the number was %i."
                      % RANDOM_NUMBER)
    ...
    print("That is invalid, your choice must be a number")
    start_game()
